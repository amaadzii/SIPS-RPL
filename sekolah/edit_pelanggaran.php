      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg">
            ...
            <div class="d-sm-none d-lg-inline-block">Hi, Pegawai</div></a>
        ...
        <aside id="sidebar-wrapper">
          ...
          <div class="sidebar-user">
            ...
            <div class="sidebar-user-details">
              <div class="user-name">Jasmine Athira</div>
              <div class="user-role">
                Pegawai
              </div>
            </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li data-toggle="tooltip" data-placement="right" data-original-title="Data Siswa">
              <a href="data_siswa.html"><i class="ion ion-ios-people"></i> Data Siswa</a>
            </li>
            <li data-toggle="tooltip" data-placement="right" data-original-title="Data Jurusan">
              <a href="data_jurusan.html"><i class="ion ion-university"></i> Data Jurusan</a>
            </li>
            <li data-toggle="tooltip" data-placement="right" data-original-title="Data Kelas">
              <a href="data_kelas.html"><i class="ion ion-ios-book"></i> Data Kelas</a>
            </li>
            <li data-toggle="tooltip" data-placement="right" data-original-title="Data Jenis Pelanggaran">
              <a href="data_jenispelanggaran.html"><i class="ion ion-document-text"></i> Jenis Pelanggaran</a>
            </li>
            <li class="active" data-toggle="tooltip" data-placement="right" data-original-title="Data Pelanggaran Siswa">
              <a href="data_pelanggaran.html"><i class="ion ion-android-alert"></i> Pelanggaran Siswa</a>
            </li>
          </ul>
        </aside>
      </div>
            ...
            <div class="card-primary">
              <div class="card-body">
               ...
               <div class="form-group">
                ...
                <select name="" class="form-control">
                 <option>Tidak memakai Dasi</option>
               </select>
             </div>
             <div class="form-group">
              <label>Keterangan</label>
              <input value="Jangan diulangi!" type="text" class="form-control" name="" tabindex="1" required>
            </div>
            <div class="form-group">
              <label>Tanggal</label>
              <input value="06/04/2021" type="date" class="form-control" name="" tabindex="1" required>
            </div><br>
            <div class="form-group">
